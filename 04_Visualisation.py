...
Dat = T#[T["Norm"]<2]
plot = sb.swarmplot(x ="Interval", y = "Tet_F",hue = "Type", size = 5,dodge=True,  data=Dat,palette ="tab10")
plot = sb.boxplot(x ="Interval", y = "Tet_F",hue = "Type",color = "gray",dodge=True, data=Dat,palette =(pal),boxprops=dict(alpha=.2))
